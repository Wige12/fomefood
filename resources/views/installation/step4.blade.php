...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="INSTALAÇÃO | SOFTWARE DELIVERY | BRASTOM"
             ...
             data-bs-placement="top" data-bs-custom-class="custom-progress-tooltip" data-bs-title="5ª Etapa"
    ...
    <div class="card mt-4 position-relative">
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="d-flex align-items-center column-gap-3 flex-wrap">
                <h5 class="fw-bold fs text-uppercase">5ª Etapa </h5>
                <h5 class="fw-normal">Importar Banco de Dados</h5>
            </div>
            <p class="mb-5">
                Seu banco de dados foi conectado! Basta clicar na seção para importar automaticamente o banco de dados.
            </p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-danger">
                            Seu banco de dados não está limpo. Deseja limpá-lo e depois importá-lo?
                        </div>
                    </div>
                </div>
