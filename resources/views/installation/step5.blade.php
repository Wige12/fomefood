...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="INSTALAÇÃO | SOFTWARE DELIVERY | BRASTOM"
             ...
             data-bs-placement="top" data-bs-custom-class="custom-progress-tooltip" data-bs-title="6ª Etapa"
    ...
    <div class="card mt-4 position-relative">
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="d-flex align-items-center column-gap-3 flex-wrap">
                <h5 class="fw-bold fs text-uppercase">6ª Etapa </h5>
                <h5 class="fw-normal">Configuração do Administrador</h5>
            </div>
            <p class="mb-4">Essas informações serão usadas para criar <strong>um super acesso administrativo</strong>
                para seu painel.
            </p>
        ...
        @endif
            ...
            <form method="POST" action="{{ route('system_settings',['token'=>bcrypt('step_6')]) }}">
                        ...
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="from-group">
                                    <label for="first-name" class="d-flex align-items-center gap-2 mb-2">Nome do Negócio</label>
                                    <input type="text" id="first-name" class="form-control" name="web_name"
                                           required placeholder="Ex.: Meu Negócio Delivery">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                                ...
                                <div class="from-group">
                                    <label for="phone" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              ...
                                              data-bs-html="true"
                                              data-bs-title="Forneça um número válido. Este número será usado para enviar o código de verificação e outros anexos no futuro.">
                                                    <img
                                ...
                                <div class="from-group">
                                    <label for="email" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                              data-bs-html="true"
                                              data-bs-title="Forneça um e-mail válido. Este e-mail será usado para enviar código de verificação e outros anexos no futuro.">
                                                    <img
                                                        src="{{asset('public/assets/installation')}}/assets/img/svg-icons/info2.svg"
                                                        class="svg" alt="">
                                                </span>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="confirm-password" class="d-flex align-items-center gap-2 mb-2">Confirmar Senha</label>
                                    <div class="input-inner-end-ele position-relative">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-dark px-sm-5">Completar Instalação</button>
                </div>
            </form>
        </div>
    </div>
